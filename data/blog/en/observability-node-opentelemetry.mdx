...
![Grafana Explore with Loki and service_name filter](/static/images/observability-node/loki-explore-logs.png)
...
![Trace in Grafana Tempo with Express and database spans](/static/images/observability-node/tempo-trace-waterfall.png)
...
![HTTP and Node runtime metrics in Grafana](/static/images/observability-node/grafana-metrics-node-runtime.png)
